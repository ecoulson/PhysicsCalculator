...
var SyntaxTree = /** @class */ (function () {
    ...
    SyntaxTree.prototype.readSums = function () {
        ...
        while (!this.hasReadAllTokens() && !this.isNextToken(TokenType_1.TokenType.Absolute) && !this.isNextToken(TokenType_1.TokenType.RightParentheses) && (this.isNextToken(TokenType_1.TokenType.Add) || this.isNextToken(TokenType_1.TokenType.Subtract))) {
    ...
    SyntaxTree.prototype.readFactor = function () {
        ...
        while (!this.hasReadAllTokens() && (this.isNextToken(TokenType_1.TokenType.Multiply) || this.isNextToken(TokenType_1.TokenType.Divide))) {
            var operatorToken = this.readToken();
            var operatorNode = new OperatorNode_1.OperatorNode(operatorToken);
    ...
    SyntaxTree.prototype.readTerm = function () {
        ...
        else if (this.isNextToken(TokenType_1.TokenType.Identifier)) {
    ...
    SyntaxTree.prototype.readSign = function () {
        var sign = 1;
        var pos = this.offset;
        while (this.isNextToken(TokenType_1.TokenType.Subtract)) {
            sign *= -1;
            this.readToken();
        }
    ...
    SyntaxTree.prototype.readComplexUnit = function () {
        ...
        while (!this.hasReadAllTokens() && (this.isNextToken(TokenType_1.TokenType.Divide) || this.isNextToken(TokenType_1.TokenType.Multiply))) {
            var operatorToken = this.readToken();
            var operatorNode = new OperatorNode_1.OperatorNode(operatorToken);
